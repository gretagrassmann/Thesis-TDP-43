...
class Zernike3D:
    ...
    def PrepareImageFromFile(self, imagefile):
        '''
    ...
    def LoadImage(self, image):
        '''
        This function gets in input a NlxNlxNl voxellized image and return a 3 x Nl linear array containg the value of each voxel.
        It also inizialize the Zernike class, in case Nl is different from the one stored in memory.
        '''
